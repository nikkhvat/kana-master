...
import EducationKanaSelectedCard, { CardType } from "@/entities/education/practice/education-select-letters/education-select-letters";
...
const EducationPractice: React.FC<PracticeProps> = ({ navigation }) => {
  ...
  const hiraganaLength = letters.base.hiragana.length +
    letters.dakuon.hiragana.length +
    letters.handakuon.hiragana.length +
    letters.yoon.hiragana.length;
  
  const katakanaLength = letters.base.katakana.length +
