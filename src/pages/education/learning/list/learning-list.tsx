  ...
  return (
    <SafeLayout style={{flex: 1, paddingBottom: 0}} disableLeft disableRight >
      ...
      <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false} >
        ...
        <Text style={[styles.title, { color: colors.color4 }]} >Chapter 2</Text>
        <Text style={[styles.subtitle, { color: colors.color4 }]} >2/9 completed</Text>
        {list2.map((item, index) =>
          <TopicItem 
            ...
            state={activeLesson === item.title ? TopicItemState.Opened : TopicItemState.CLosed}
            last={index + 1 === list2.length} />)} */}
      </ScrollView>
    </SafeLayout>
  );
};
